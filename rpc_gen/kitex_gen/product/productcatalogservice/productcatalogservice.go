...
var ListProductsArgs_Req_DEFAULT *product.ListProductReq

func (p *ListProductsArgs) GetReq() *product.ListProductReq {
	if !p.IsSetReq() {
...
var ListProductsResult_Success_DEFAULT *product.ListProductResp
...
func (p *ListProductsResult) GetSuccess() *product.ListProductResp {
	if !p.IsSetSuccess() {
