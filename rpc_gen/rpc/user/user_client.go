...
type RPCClient interface {
	...
	GetUserByUserId(ctx context.Context, Req *user.GetUserByUserIdReq, callOptions ...callopt.Option) (r *user.GetUserByUserIdResp, err error)
}
...
func (c *clientImpl) GetUserByUserId(ctx context.Context, Req *user.GetUserByUserIdReq, callOptions ...callopt.Option) (r *user.GetUserByUserIdResp, err error) {
	return c.kitexClient.GetUserByUserId(ctx, Req, callOptions...)
}
